...
X_train, Y_train, feature_names = load_TrainingData('../data/train.tsv')
X_test,X_test_PhraseID = load_TestingData('../data/test.tsv')
...
print("documents for fitting shape: ", X_train.shape)
print("documents for fitting", X_train[:100])
...
print("X Train encoded padded words: ", X_Train_encodedPadded_words)
print("X Tarin encoded words shape: ", X_Train_encodedPadded_words.shape)
...
print("maxDictionary_size: ", maxDictionary_size)
...
print("X_train: ", X_Train_encodedPadded_words)
print("Y_train: ", Y_train)
print("X_val: ", X_Val_encodedPadded_words)
print("Y_val: ", Y_Val)
print("BATCH SIZE: ", batch_size)

history  = model.fit(X_Train_encodedPadded_words, Y_train, epochs = epochs, batch_size=batch_size, verbose=1,
                    validation_data=(X_Val_encodedPadded_words, Y_Val), callbacks=[reduce_lr,earlyStopping])
